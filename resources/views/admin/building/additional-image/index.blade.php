                ...
                <div class="panel panel-default" style="padding: 20px;">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('admin.building.additional-images.store') }}" 
                                enctype="multipart/form-data" 
                                class="dropzone" 
                                id="image-upload">
                                @csrf
                                <input type="hidden" name="buildingCode" value="{{ $data->building_code ?? null }}">
                            </form>
                                    ...
                                    <tbody>
                                        @if (isset($files))
                                            @foreach ($files as $value)
                                                @php
                                                $filePath = asset('storage/assets/admin/images/building/' . $data->building_image);
                                            ...
                                            <tr>
                                                ...
                                                {{-- ✅ DELETE --}}
                                                <td class="text-center">
                                                    <form action="{{ route('admin.building.additional-images.destroy', $value->id) }}" 
                                                        method="POST"
