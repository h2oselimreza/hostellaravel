...
<div class="header dashboard_from">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ url('admin/seat') }}">Seat</a></li>
        <li><a href="{{ route('admin.seat.update',[$data->seat_code]) }}">/ Update Seat</a></li>
    </ul>
</div>
...
<div class="main-content">
    ...
    <div class="card from_card">
        ...
        <div class="card-body" x-data="vehicleForm()">
            <form 
                action="{{ isset($data->exists) ? route('admin.seat.image.update', $data->seat_code) : route('admin.seat.image.store') }}"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            @if($data->seat_image)
                                <img
                                    src="{{ asset('storage/assets/admin/images/seat/' . $data->seat_image) }}"
                                    class="profile-image"
                                    alt="seat Image">
                            @else
                                <img
                            ...
                            <input type="hidden" name="old_image" value="{{ $data->seat_image ?? "" }}">
                            @error('seat_image')
