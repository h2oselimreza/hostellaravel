...
<div class="header dashboard_from">
    ...
    <ul class="breadcrumb">
        <li><a href="{{ url('admin/master-data/cost-category') }}">Home</a></li>
        <li><a href="#">/ Master Data</a></li>
        <li><a href="/admin/master-data/cost-category/create">/ Expense Category</a></li>
    </ul>
</div>
        ...
        <div class="card-body" x-data="vehicleForm()">
            ...
            >
                ...
                <div class="ps-0 card-footer bg-white d-flex gap-2">
                    ...
                    <a href="{{ url('admin/master-data/cost-category') }}" class="btn btn-outline-secondary">
                        Cancel
                    </a>
                </div>
            </form>
