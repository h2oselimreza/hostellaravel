...
<div class="header dashboard_from">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ url('admin/master-data/income/income-category') }}">/ Income Category</a></li>
    </ul>
</div>
        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="panel panel-default"> 
                <div class="add-button">
                    <a href="{{ route('admin.module.master-data.income-category.create') }}">Add Income Category</a>
                </div>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ $value ? route('admin.module.master-data.income-category.edit', $value->category_code ) : '#' }}" 
                                                        class="d-block ps-3">
