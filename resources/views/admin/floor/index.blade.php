        ...
        <div class="col-sm-12 col-md-12">
            ...
            <div class="panel panel-default"> 
                <div class="add-button">
                    <a href="{{ route('admin.floor.create') }}">Add Floor</a>
                </div>
                    ...
                    <table class="table table-bordered table-hover custom-table" id="datatable">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <th class="text-center">Floor Code</th>
                                <th class="text-start">Floor Title</th>
                        ...
                        <tbody>
                            @forelse ($data as $value)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $value->buildingInfo?->title }}</td>
                                    <td class="text-center">{{ $value->floor_code }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="{{ $value ? route('admin.floor.edit', $value->floor_code) : '#' }}" 
                                                    class="d-block ps-3">
