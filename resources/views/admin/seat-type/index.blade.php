...
<div class="header dashboard_from">
    <h1 class="page-title">Seat Type</h1>
    <ul class="breadcrumb">
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-default"> 
                <div class="add-button">
                    <a href="{{ route('admin.seat.type.create') }}">Add Seat Type</a>
                </div>
                    ...
                    <table class="table table-bordered table-hover custom-table" id="datatable">
                        <thead>
                            <tr class="bg-primary">
                                ...
                                <th class="text-center">Seat Type Code</th>
                                <th class="text-start">Seat Type Title</th>
                        ...
                        <tbody>
                            @forelse ($data as $value)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $value->seat_type_code }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="{{ $value ? route('admin.seat.type.edit', $value->seat_type_code) : '#' }}" 
                                                    class="d-block ps-3">
