            ...
            <div id="my-div" class="my-div">
                ...
                <div id="" class="content-div">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" align="center" width="726">
                        ...
                        <tr>
                            <td align="center" class="body-heading2">Statement of <?php echo  ($reportType == 'boarderwise') ? 'Boader':'' ?> Wise Income</td>
                        </tr>
                        <tr>
                    ...
                    <table class="description" cellpadding="0" cellspacing="0" width="726">
                        <tr>
                            <th class="bottom-border right-border" width="590"><b><?php echo ($reportType == 'boarderwise') ? 'Boader' : '' ?></b></th>
                            <th class="bottom-border right-border" width="136"><b>Income (BDT)</b></th>
                        </tr>
                        <?php
                        $totalIncome = 0;
                        foreach ($boarderDetails as $boarderDetail) {
                            if ($reportType == 'boarderwise') {
                                $tdLabel = $boarderDetail->boarder_name;
                            } 
                            echo "<tr>";
                            echo "<td class='top-border right-border' align='left'>" . $tdLabel . "</td>";
                            echo "<td class='top-border right-border' align='right'>" . number_format($boarderDetail->total_income, 2) . "</td>";
                            echo "</tr>";
                            $totalIncome += $boarderDetail->total_income;
                        }
                        echo "<tr>";
                        echo "<td class='top-border right-border' align='right'><b>Grand Total</b></td>";
                        echo "<td class='top-border right-border' align='right'><b>" . number_format($totalIncome, 2) . "</b></td>";
                        echo "</tr>";
                        ?>
                    </table>
                    <?php
