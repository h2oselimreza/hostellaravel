...
var mergeConfig2 = (method2, url, data, config) => ({
  ...
  ...["get", "delete"].includes(method2) ? {
    params: merge_default({}, data, config?.params)
  } : {
    data: merge_default({}, data, config?.data)
  }
});
    ...
    const createForm = () => ({
      ...
      validate(name, config2) {
        ...
        if (typeof name === "undefined") {
          ...
          validator.validate(resolvedName, get_default(form.data(), resolvedName), config2);
        }
        return form;
      },
      validating: false,
