...
return new class extends Migration
{
    ...
    {
        Schema::create('boarder_working_experience', function (Blueprint $table) {
            $table->id();

            $table->string('boarder_id', 64);
    ...
    {
        Schema::dropIfExists('boarder_working_experience');
    }
};
